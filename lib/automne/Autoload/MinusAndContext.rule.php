...
require_once 
    implode(DIRECTORY_SEPARATOR, array(__DIR__, 'Abstract', 'Rule.php'));
 ...
 * @author   Gregory Salvan <gregory.salvan@apieum.com>
 * @license  GPL v.2
 * @link     ATM_Autoload_MinusAndContext
 *
 */
class ATM_Autoload_MinusAndContext extends ATM_Autoload_Rule_Abstract
{
    ...
    {
        $params = new ATM_Autoload_RuleParams(&$context, $params);
