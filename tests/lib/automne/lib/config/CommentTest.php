...
/**
 * Test class for atmConfigComment.
 * 
 * @category AutomneTests
 * @package  Tests/Config
 * @author   Gregory Salvan <gregory.salvan@apieum.com>
 * @license  GPL v.2
 * @link     atmConfigComment
 *
 */
class atmConfigCommentTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var atmConfigComment
     */
    protected $object;
    ...
    {
        $this->object = new atmConfigComment('');
    }
