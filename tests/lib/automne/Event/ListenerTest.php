<?php
/**
 * File ATM_Event_ListenerTests.php
 *
 * PHP version 5.2
 *
...
/**
 * Test class for ATM_Event_Listener.
 * 
 * @category AutomneTests
 * @package  Tests/Event
 * @author   Gregory Salvan <gregory.salvan@apieum.com>
 * @license  GPL v.2
 * @link     ATM_Event_ListenerTest
 *
 */
class ATM_Event_ListenerTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var ATM_Event_Listener
     */
    protected $object;
    ...
    {
        $this->object = new ATM_Event_Listener();
    }
    /**
